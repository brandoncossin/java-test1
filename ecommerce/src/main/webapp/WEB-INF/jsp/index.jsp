...
<body>
    ...
    <div id="main-content" class="container">
        ...
        <div class="col-md-3 col-sm-6 my-3 my-md-0">
          ...
          <div>
          <img src="../images/product0.png" class= "img-fluid card-img-top" style="height:300px;">
          </div>
          <div class= "card-body">
      ...
      <div class="col-md-3 col-sm-6 my-3 my-md-0">
        ...
        <div class="card shadow">
        <div>
        <img src="../images/product1.png" class= "img-fluid card-img-top" style="height:300px;">
        </div>
        <div class= "card-body">
    ...
    <div class="col-md-3 col-sm-6 my-3 my-md-0">
        ...
        <div class="card shadow">
        <div>
        <img src="../images/product2.png" class= "img-fluid card-img-top" style="height:300px;">
        </div>
        <div class= "card-body">
