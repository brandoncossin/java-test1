...
<body>
    ...
    <div class="d-flex justify-content-center mt-5">
        <section className="row justify-content-center">
            <form id="signup-form" method="post" className="form-container" action="/signup" modelAttribute="SignupForm">
                <div class="card-body">
                    <h3>Log Up to E-Commerce Tech Store</h3>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="firstNameField" placeholder="Enter First Name" name="first_name" path="first_name">
                    </div>
                    <div class="form-group">
                        <label for="lastNameField">Last Name</label>
                        <input type="text" class="form-control" id="lastNameField" placeholder="Enter Last Name" name="last_name" path="last_name">
                    </div>
                    <div class="form-group">
                    ...
                    <br></br>
                    <a href="/signup">Already a member? Sign in today!</a>
                </div>
            </form>
